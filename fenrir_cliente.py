    ...
    with grpc.insecure_channel(address) as channel:
        ...
        if args.command == "criar":
            ...
            for tarefa in resposta_lista.tarefas:
                ...
                print(f"  Decrição: {tarefa.descricao}\n")
                ...
                tarefa_obj.titulo = args.titulo if args.titulo else tarefa_obj.titulo
                tarefa_obj.descricao = args.descricao if args.descricao else tarefa_obj.descricao
            ...
            print("Deletando a tarefa: {args.id}\n")
